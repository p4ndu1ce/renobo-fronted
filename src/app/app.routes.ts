...
export const routes: Routes = [
  ...
  { path: 'partner/service/:workId', loadComponent: () => import('./pages/partner-tracking/partner-service-detail.component').then((m) => m.PartnerServiceDetailComponent), canActivate: [authGuard, roleGuard], data: { title: 'Detalle del servicio', roles: ['PARTNER'] } },
