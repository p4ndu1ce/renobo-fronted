...
import { ServiceDetailComponent } from './pages/seguimiento/service-detail.component';
...
export const routes: Routes = [
  // Layout principal: vacío y todas las rutas internas (home, servicios, etc.)
  {
    ...
    children: [
      ...
      { path: 'request-success', component: RequestSuccessComponent, data: { title: 'Solicitud enviada' } },
      { path: 'calculadora', component: CalculadoraComponent },
      { path: 'seguimiento', component: ServiceDetailComponent, data: { title: 'Seguimiento' } },
